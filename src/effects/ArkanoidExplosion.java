...
public class ArkanoidExplosion {
    ...
    public ArkanoidExplosion(AssetManager assetManager, Vector3f position, Node rootNode){
    ...
    private void createShockwave() {
        shockwave = new ParticleEmitter("Shockwave", Type.Triangle, 22 * COUNT_FACTOR);
